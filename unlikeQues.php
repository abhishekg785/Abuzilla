...
$uid=$res['userid'];
mysql_query("delete from quesStatus where quesId=\"$quesId\"  and userId=\"$uid\" and status=\"like\"");
$qt=mysql_query("select *  from quesStatus where quesId=\"$quesId\"  and userId=\"$uid\" and status=\"unlike\"");
if(!mysql_num_rows($qt)){
mysql_query("insert into quesStatus values('','$quesId','$uid','unlike')");
}
