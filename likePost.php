...
$uid=$res['userid'];
mysql_query("delete from post_status where post_id=\"$postId\"  and user_id=\"$uid\" and status=\"unlike\"");
$qt=mysql_query("select * from post_status where post_id=\"$postId\"  and user_id=\"$uid\" and status=\"like\"");
if(!mysql_num_rows($qt)){
mysql_query("insert into post_status values('','$postId','$uid','like')");
}
