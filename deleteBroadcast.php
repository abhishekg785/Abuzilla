...
$uid=$_SESSION['uid'];
$bId=$bId;
$query=mysql_query("select queryId from broadcastQuery where bId='$bId'");
while($res=mysql_fetch_assoc($query))
{
  $qId=$res['queryId'];//query iD
  mysql_query("delete from replyToQueryOfBroadcast where qId='$qId'");
}
mysql_query("delete from userBroadcast where bId='$bId'");
mysql_query("delete from broadcastQuery where bId='$bId'");
?>
